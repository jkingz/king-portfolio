...
<template>
  ...
  >
    ...
    <PrismicRichText
      ...
      wrapper="div"
    />
    <div class="mt-8 grid grid-rows-[auto_auto_auto] max-w-4xl gap-8 md:grid-cols-3 md:gap-10">
      <article
        ...
        <PrismicImage :field="item.image" class="max-h-36 w-full object-cover rounded-xl"/>
      </article>
    </div>
  </AppBounded>
</template>
